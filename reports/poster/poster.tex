...
\draw[arrow] (full) -- node[right, text=mutedgray] {cheaper PEFT} (lora);
\draw[arrow] (lora) -- node[left, text=mutedgray] {parameterization} (dora);
\draw[arrow] (lora) -- node[right, text=mutedgray] {optimization} (lorapro);
