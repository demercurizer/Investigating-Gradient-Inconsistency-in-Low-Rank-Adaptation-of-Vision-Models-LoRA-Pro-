...
\node[text=mutedgray] at (0,-1.75) {reachable equivalent gradients};
...
\draw[fullgrad] (o) -- (g)
    node[pos=0.63, right, text=titleblue] {$g=\partial\mathcal{L}/\partial W$};
...
\node[align=left, text=mutedgray] at (1.5,-4.05) {
    \textcolor{titleblue}{blue}: full fine-tuning gradient \(g\)\\
