...
\coordinate (gaend) at (-1.35,0.38);
\coordinate (sum) at (2.25,0.70);
\coordinate (g) at (2.25,3.25);

\draw[ga] (o) -- (gaend)
    node[pos=0.54, above, text=titleblue] {$sBg_A$};

\draw[gb] (gaend) -- (sum)
    node[pos=0.55, above, text=orange!85!black] {$sg_BA$};
...
\node[align=left, text=mutedgray] at (2.0,-1.05) {
